...
{
    /// <inheritdoc />
    public partial class AgregarProveedorClienteSucursal : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProveedorMedicamentos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProveedorMedicamentos_Proveedores_IdProveedor",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProveedorMedicamentos_IdProveedor",
                table: "ProveedorMedicamentos",
                column: "IdProveedor");

            migrationBuilder.CreateIndex(
                name: "IX_ProveedorMedicamentos_IdMedicamento",
                table: "ProveedorMedicamentos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesVenta_IdMedicamento",
                table: "DetallesVenta",
                column: "IdMedicamento");
        }
        ...
        {
            migrationBuilder.DropTable(name: "DetallesVenta");
            migrationBuilder.DropTable(name: "ProveedorMedicamentos");
